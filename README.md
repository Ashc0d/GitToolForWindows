...
GitTool `0.2.0` is a native Windows Git utility built with C#, .NET 10 LTS, WinUI 3, and the stable Windows App SDK. It provides focused clone and repository-management workflows in a continuous Mica Alt shell.
